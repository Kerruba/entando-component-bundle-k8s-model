...
public class EntandoComponentBundleDetails implements Serializable {
    ...
    public EntandoComponentBundleDetails(String name, String description, Map<String, Object> distTags, List<String> versions,
    ...
    public EntandoComponentBundleDetails() {
    }
