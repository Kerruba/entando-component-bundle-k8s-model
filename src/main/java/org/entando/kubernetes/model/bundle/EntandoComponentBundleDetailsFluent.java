...
public abstract class EntandoComponentBundleDetailsFluent<N extends EntandoComponentBundleDetailsFluent<N>> {
    ...
    public EntandoComponentBundleDetailsFluent() {
        this.distTags = new ConcurrentHashMap<>();
        this.versions = new ArrayList<>();
        this.keywords = new ArrayList<>();
    }

    public EntandoComponentBundleDetailsFluent(EntandoComponentBundleDetails details) {
    ...
    public EntandoComponentBundleDetails build() {
        return new EntandoComponentBundleDetails(name, description, distTags, versions, keywords, thumbnail);
    }
